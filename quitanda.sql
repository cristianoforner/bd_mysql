...
-- Ordenar os dados 
SELECT * FROM tb_produtos ORDER BY nome; -- crescente 
SELECT * FROM tb_produtos ORDER BY nome DESC; -- decrescente
...
SELECT * FROM tb_produtos WHERE nome LIKE "%ra%"; -- silaba em qualquer lugar da palavra

SELECT * FROM tb_produtos WHERE nome LIKE "%ra"; -- ultima silaba

SELECT * FROM tb_produtos WHERE nome LIKE "ra%"; -- primeira silaba
